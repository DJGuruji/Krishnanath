  ...
  return (
    <>
      <div className="pt-20 pl-10 bg-black text-white px-5 md:w-1/2 lg:w-1/2 xl:w-1/2 ">
        <h2 className="font-sans text-xl font-semibold text-yellow-300">
          Hello!
        </h2>
        <h1 className="text-2xl font-sans">I Am Krishnanath S</h1>
        <p className="pt-3 text-lg text-justify ">
