          ...
          <div className="md:flex hidden">
            <ul className="flex text-lg">
              <li className="mt-2 p-2 text-white font-light hover:font-bold">
                <Link to="/" onClick={handleItemClick} className="flex"><FaHome className="m-1"/>
                  Home
                </Link>
              </li>
              <li className="p-2 mt-2 text-white font-light hover:font-bold">
                <Link to="/about" onClick={handleItemClick} className="flex"><FaFileAlt className="m-1"/>
                  About
                </Link>
              </li>
              <li className="p-2 mt-2 text-white font-light hover:font-bold">
                <Link to="/service" onClick={handleItemClick} className="flex"><MdOutlineMiscellaneousServices className="m-1"/>
                  Service
                </Link>
              </li>
              <li className="p-2 mt-2 text-white font-light hover:font-bold">
                <Link to="/projects" onClick={handleItemClick} className="flex"><FaDiagramProject className="m-1"/>
                  Projects
                </Link>
              </li>
              <li className="p-2 mt-2 text-white font-light hover:font-bold">
                <Link to="/contact" onClick={handleItemClick} className="flex"><IoMdContact className="m-1 text-xl"/>
                  Contact
                </Link>
              </li>
            </ul>
